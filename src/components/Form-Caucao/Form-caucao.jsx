          ...
          <form onSubmit={handleSubmit(sendData)}>
            <div className="section-card">
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="objContrato"
                  {...register("objContrato", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <InputMask
                  ...
                  mask="99999-999"
                  name="cepObjeto"
                  {...register("cepObjeto", { required: true })}
                  onBlur={getCepObjeto}
                ></InputMask>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="endObjeto"
                  {...register("endObjeto", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="numObjeto"
                  {...register("numObjeto", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="bairroObjeto"
                  {...register("bairroObjeto", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="cidadeObjeto"
                  {...register("cidadeObjeto", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="ufObjeto"
                  {...register("ufObjeto", { required: true })}
                />
                <p className="error-message">{errors.cidadeObjeto?.message}</p>
              </div>
            </div>
            ...
            <div className="section-card">
              ...
              <div className="fields">
                ...
                <input
                  ...
                  {...register("profissaoLocador", { required: true })}
                ></input>
                <p className="error-message">
                  {errors.profissaoLocador?.message}
                </p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="ufExpedicao"
                  {...register("ufExpedicao", { required: true })}
                ></input>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="ruaLocador"
                  {...register("ruaLocador", { required: true })}
                ></input>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="numLocador"
                  {...register("numLocador", { required: true })}
                ></input>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="compLocador"
                  {...register("compLocador", { required: true })}
                ></input>
            ...
            <div className="section-card">
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="ufExpedicaoLocatario"
                  {...register("ufExpedicaoLocatario", { required: true })}
                ></input>
                <p className="error-message">
                  {errors.ufExpedicaoLocatario?.message}
                </p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  {...register("profissaoLocatario", { required: true })}
                ></input>
                <p className="error-message">
                  {errors.profissaoLocatario?.message}
                </p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="ruaLocatario"
                  {...register("ruaLocatario", { required: true })}
                ></input>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="numLocatario"
                  {...register("numLocatario", { required: true })}
                ></input>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  name="compLocatario"
                  {...register("compLocatario", { required: true })}
                ></input>
            ...
            <div className="section-card">
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="prazoVigencia"
                  {...register("prazoVigencia", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <InputMask
                  ...
                  type="text"
                  name="termino"
                  {...register("termino", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="valorMensal"
                  {...register("valorMensal", { required: true })}
                />
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  type="text"
                  name="valorMensalAluguelEscrito"
                  {...register("valorMensalAluguelEscrito", { required: true })}
                />
                <p className="error-message">
                  {errors.valorMensalAluguelEscrito?.message}
                </p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  {...register("valorGarantiaCaucao", { required: true })}
                />
                <p className="error-message">
                  {errors.valorGarantiaCaucao?.message}
                </p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="ciaEletrica"
                  {...register("ciaEletrica", { required: true })}
                />
            ...
            <div className="section-card">
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  type="text"
                  name="ufExpedicaoCorretor"
                  {...register("ufExpedicaoCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="numCreci"
                  {...register("numCreci", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="ruaCorretor"
                  {...register("ruaCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="numCorretor"
                  {...register("numCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  type="text"
                  name="valorServicoCorretor"
                  {...register("valorServicoCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  className="card-input"
                  type="text"
                  name="valorServicoEscrito"
                  {...register("valorServicoEscrito", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="agCorretor"
                  {...register("agCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
              ...
              <div className="fields">
                ...
                <input
                  ...
                  type="text"
                  name="pixCorretor"
                  {...register("pixCorretor", { required: true })}
                />
                <p className="error-message">{errors.campo?.message}</p>
              </div>
            </div>
